...
import com.timeshipmodding.villagecraft2essentials.datagen.LootTables;
...
public class BaseLootTableProvider extends VanillaBlockLoot {
    ...
    protected Iterable<Block> getKnownBlocks() {
        return ForgeRegistries.BLOCKS.getEntries().stream()
                .filter(e -> e.getKey().location().getNamespace().equals(VillageCraft2Essentials.MODID))
