package com.timeshipmodding.villagecraft2essentials.content.entity;
...
public class MoleEntity extends Animal {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(3, new TemptGoal(this, 1.25, stack -> stack.is(ModItems.AMBER), false));
    ...
    public boolean isFood(ItemStack itemStack) {
        // Change to worm
        return itemStack.is(ModItems.AMBER.get());
    }
