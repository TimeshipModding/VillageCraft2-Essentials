package com.timeshipmodding.villagecraft2essentials.content.entity.client.models;

import com.mojang.blaze3d.vertex.PoseStack;
import com.mojang.blaze3d.vertex.VertexConsumer;
import com.timeshipmodding.villagecraft2essentials.content.entity.MoleEntity;
import com.timeshipmodding.villagecraft2essentials.content.entity.client.animations.MoleAnimations;
...
public class MoleModel extends HierarchicalModel<MoleEntity> {
    ...
    public void setupAnim(MoleEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animateWalk(MoleAnimations.ANIM_PENGUIN_WALK, limbSwing, limbSwingAmount, 2f, 2.5f);
        this.animate(entity.idleAnimationState, MoleAnimations.ANIM_PENGUIN_IDLE, ageInTicks, 1f);
    }
