...
public class EssentialsTab {
    ...
    public static final RegistryObject<CreativeModeTab> ESSENTIALS_TAB = CREATIVE_MODE_TABS.register("essentials_tab", () ->
            ...
            .displayItems((pParametres, pOutput) -> {
                ...
                pOutput.accept(LIGHT_GRAY_ATM.get());
                pOutput.accept(GRAY_ATM.get());
                pOutput.accept(BLACK_ATM.get());
                pOutput.accept(BROWN_ATM.get());
                pOutput.accept(RED_ATM.get());
                pOutput.accept(ORANGE_ATM.get());
                pOutput.accept(YELLOW_ATM.get());
                pOutput.accept(LIME_ATM.get());
                pOutput.accept(GREEN_ATM.get());
                pOutput.accept(CYAN_ATM.get());
                pOutput.accept(LIGHT_BLUE_ATM.get());
                pOutput.accept(BLUE_ATM.get());
                pOutput.accept(PURPLE_ATM.get());
                pOutput.accept(MAGENTA_ATM.get());
                pOutput.accept(PINK_ATM.get());
