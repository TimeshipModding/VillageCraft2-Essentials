package com.timeshipmodding.villagecraft2essentials.content.trim.registries;
...
public class ModTrimMaterials {
    public static final ResourceKey<TrimMaterial> RUBY =
            ResourceKey.create(Registries.TRIM_MATERIAL, ResourceLocation.fromNamespaceAndPath(VillageCraft2Essentials.MODID, "ruby"));
