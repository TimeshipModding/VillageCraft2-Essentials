...
import com.timeshipmodding.villagecraft2essentials.content.trim.registries.ModTrimMaterials;
...
public class DataItemModels extends ItemModelProvider {
    ...
    private void trimmedArmorItem(DeferredItem<Item> itemDeferredItem) {
        final String MOD_ID = VillageCraft2Essentials.MODID; // Change this to your mod id
