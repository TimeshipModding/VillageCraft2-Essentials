...
public class DataRecipes extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, BLACK_ATM.get()).requires(WHITE_ATM.get()).requires(BLACK_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, BLUE_ATM.get()).requires(WHITE_ATM.get()).requires(BLUE_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, BROWN_ATM.get()).requires(WHITE_ATM.get()).requires(BROWN_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, CYAN_ATM.get()).requires(WHITE_ATM.get()).requires(CYAN_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, GRAY_ATM.get()).requires(WHITE_ATM.get()).requires(GRAY_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, GREEN_ATM.get()).requires(WHITE_ATM.get()).requires(GREEN_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, LIGHT_BLUE_ATM.get()).requires(WHITE_ATM.get()).requires(LIGHT_BLUE_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, LIGHT_GRAY_ATM.get()).requires(WHITE_ATM.get()).requires(LIGHT_GRAY_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, LIME_ATM.get()).requires(WHITE_ATM.get()).requires(LIME_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, MAGENTA_ATM.get()).requires(WHITE_ATM.get()).requires(MAGENTA_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, ORANGE_ATM.get()).requires(WHITE_ATM.get()).requires(ORANGE_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, PINK_ATM.get()).requires(WHITE_ATM.get()).requires(PINK_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, PURPLE_ATM.get()).requires(WHITE_ATM.get()).requires(PURPLE_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, RED_ATM.get()).requires(WHITE_ATM.get()).requires(RED_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
        ShapelessRecipeBuilder.shapeless(RecipeCategory.DECORATIONS, YELLOW_ATM.get()).requires(WHITE_ATM.get()).requires(YELLOW_DYE).group("villagecraft2essentials").unlockedBy(getHasName(WHITE_ATM.get()), has(WHITE_ATM.get())).save(consumer);
